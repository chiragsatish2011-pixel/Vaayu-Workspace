...
const NOTE_COLORS: Record<CanvasNode["colorKey"], { bg: string; border: string; headerBorder: string; pill: string; pillText: string }> = {
  yellow: { bg: "bg-[#fefce8] dark:bg-amber-950/40 dark:text-amber-100", border: "border-amber-300/80 dark:border-amber-700/60", headerBorder: "border-amber-200/60 dark:border-amber-800/40", pill: "bg-amber-200/60 dark:bg-amber-900/60", pillText: "text-amber-900 dark:text-amber-200" },
  mint: { bg: "bg-[#f0fdf4] dark:bg-emerald-950/40 dark:text-emerald-100", border: "border-[#bbf7d0] dark:border-emerald-700/60", headerBorder: "border-emerald-100 dark:border-emerald-800/40", pill: "bg-emerald-100/70 dark:bg-emerald-900/60", pillText: "text-emerald-800 dark:text-emerald-200" },
  lilac: { bg: "bg-[#faf5ff] dark:bg-purple-950/40 dark:text-purple-100", border: "border-[#e9d5ff] dark:border-purple-700/60", headerBorder: "border-purple-100 dark:border-purple-800/40", pill: "bg-purple-100 dark:bg-purple-900/60", pillText: "text-purple-900 dark:text-purple-200" },
  peach: { bg: "bg-[#fff7ed] dark:bg-orange-950/40 dark:text-orange-100", border: "border-[#fed7aa] dark:border-orange-700/60", headerBorder: "border-orange-100 dark:border-orange-800/40", pill: "bg-orange-100 dark:bg-orange-900/60", pillText: "text-orange-900 dark:text-orange-200" },
  blue: { bg: "bg-[#f0f9ff] dark:bg-sky-950/40 dark:text-sky-100", border: "border-[#bae6fd] dark:border-sky-700/60", headerBorder: "border-sky-100 dark:border-sky-800/40", pill: "bg-sky-100 dark:bg-sky-900/60", pillText: "text-sky-900 dark:text-sky-200" },
  white: { bg: "bg-canvas dark:bg-fog dark:text-ink", border: "border-hairline", headerBorder: "border-hairline-soft", pill: "bg-fog dark:bg-mist", pillText: "text-steel dark:text-charcoal" },
};
...
export function InfiniteCanvas({
  ...
  return (
    <div className="relative h-[calc(100vh-57px)] w-full overflow-hidden bg-canvas select-none">
      {/* Canvas dot grid — infinite, follows pan/zoom so wires never appear to float over static dots */}
      <div
        className="absolute inset-0 opacity-80"
        style={{
          backgroundColor: "var(--color-canvas)",
          backgroundImage: "radial-gradient(var(--color-stone) 1.1px, transparent 1.1px)",
      ...
      <header className="absolute top-0 left-0 right-0 z-30 h-16 bg-canvas/90 backdrop-blur-md border-b border-hairline-soft px-5 flex items-center justify-between" data-ui>
      ...
      <aside className="absolute left-6 top-24 z-20 flex flex-col bg-canvas border border-hairline rounded-xl shadow-lg p-1.5 space-y-1" data-ui>
        {[
      ...
      <aside className={`absolute right-5 top-20 bottom-6 w-80 bg-canvas/95 backdrop-blur-sm border border-hairline rounded-2xl shadow-xl flex-col z-20 overflow-hidden ${showInspector ? "hidden lg:flex" : "hidden"}`} data-ui>
