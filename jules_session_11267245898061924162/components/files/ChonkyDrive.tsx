...
export function ChonkyDrive({ rootId, rootName, refreshKey, onUploaded }: { rootId: string; rootName: string; refreshKey?: number; onUploaded?: () => void }) {
  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-canvas" onDragOver={(e)=>{e.preventDefault();}} onDrop={handleDrop}>
      ...
      <div className="flex flex-1 min-h-0 flex-col bg-canvas overflow-hidden">
        ...
        <div className="border-t border-hairline bg-fog px-4 py-2 flex items-center gap-3 text-xs text-steel">
